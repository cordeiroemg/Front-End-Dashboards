...
const layout2= {
    ...
    legend: {
        ...
        xanchor: 'center',
        x: 0.5,
        y: -0.3, // move legenda para baixo do gráfico
        font: { size: 12 }
    },
    margin: { t: 60, b: 80 } // aumenta espaço inferior para acomodar a legenda
};
...
document.addEventListener('DOMContentLoaded', function() {
    Plotly.newPlot('plot1', [trace1, trace2], layout2);
});
...
const layout = {
    title: 'Convergence of X-linked Allele Frequencies Over Generation',
    xaxis: { title: 'Generation' },
    yaxis: { title: 'Frequency of AA Genotype' },
    legend: {
        orientation: 'h',
...
// Ensure the function runs after the DOM is fully loaded
document.addEventListener('DOMContentLoaded', function() {
    Plotly.newPlot('plot2', [traceMale2, traceFemale2, traceMean2], layout);
});
